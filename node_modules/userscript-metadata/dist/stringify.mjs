...
export function stringify(metadata, options = {}) {
...
export function stringifyEntries(entries, options = {}) {
...
function stringifyEntry(x) {
    return entry => (TAG_PREFIX + entry.key // tag
